...
def main():
    ...
    #approx_kl
    plot(iterations,approx_kl,approx_kl2,"10k Timesteps","20k Timesteps","Iteration","Approx_kl","Approx_kl")
    plot(iterations,entropy_loss,entropy_loss2,"10k Timesteps","20k Timesteps","Iteration","Entropy loss","Entropy loss")
    plot(iterations,explained_variance,explained_variance2,"10k Timesteps","20k Timesteps","Iteration","Explained Variance","Explained Variance")
    plot(iterations,loss,loss2,"10k Timesteps","20k Timesteps","Iteration","loss","loss2")
    plot(iterations,policy_gradient_loss,policy_gradient_loss2,"10k Timesteps","20k Timesteps","Iteration","Policy gradient loss","Policy gradient loss")
    plot(iterations,value_loss,value_loss2,"10k Timesteps","20k Timesteps","Iteration","Value Loss","Value Loss2")
